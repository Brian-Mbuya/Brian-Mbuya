<div align="center">
  ...
  <h1>Hi, I'm Brian Mbuya 👋</h1>
  <h3>Full-Stack Software Engineer & AI Systems Architect</h3>
...
<table>
  <tr>
    <td width="50%">
      ...
      <p align="center">
        <img src="https://img.shields.io/badge/React_19-Vite_PWA-blue?style=flat-square" />
        <img src="https://img.shields.io/badge/Supabase-RLS_Realtime-green?style=flat-square" />
      </p>
      <p><strong>Enterprise Offline-First Hotel Asset Management System</strong></p>
      <ul>
        <li><strong>Offline Queue:</strong> Local sequence draining for dead zones.</li>
        <li><strong>Database Security:</strong> Row-Level Security (RLS) & triggers.</li>
        <li><strong>PDF Parsing:</strong> Smart Opera PMS report diffing.</li>
        <li><strong>Test Driven:</strong> 248 unit tests verifying data integrity.</li>
      </ul>
  ...
  <tr>
    <td width="50%">
      ...
      <p align="center">
        ...
        <img src="https://img.shields.io/badge/Machine_Learning-Fraud_Screening-red?style=flat-square" />
      </p>
      <p><strong>Unsupervised Mobile Financial Anomaly Detection System</strong></p>
      <ul>
    ...
    <td width="50%">
      ...
      <p align="center">
        <img src="https://img.shields.io/badge/Spring_Boot-PostgreSQL-brightgreen?style=flat-square" />
        <img src="https://img.shields.io/badge/Security-JWT_RBAC-yellow?style=flat-square" />
      </p>
      <p><strong>Enterprise Multi-Role Submission & Review Platform</strong></p>
      <ul>
        <li><strong>Architecture:</strong> Spring Boot REST API & PostgreSQL.</li>
        <li><strong>Access Control:</strong> Role-Based Access Control (Student, Lecturer, Admin).</li>
        <li><strong>Versioning:</strong> Immutable submission tracking.</li>
      </ul>
...
1. **Resilience First:** Applications must degrade gracefully under dead-zone network conditions without losing state.
2. **Database-Enforced Security:** Security lives in database triggers and RLS policies, not just client UI.
3. **Rigorous Test Coverage:** Software is complete only when core execution paths are verified by automated tests.
...
<div align="center">
  ...
  <a href="https://www.linkedin.com/in/brian-mbuya-23225541b">
