...
<picture>
  ...
  <img src="assets/hero.svg" width="100%" alt="Brian Mbuya — Full-stack engineer · Applied AI · Reliability. Open to work. Frontend 96%, Backend 93%, Applied AI 88%. Building things that actually ship." />
</picture>
...
**Focus** &nbsp;·&nbsp; Full-Stack · Backend · Applied AI · Payments &amp; M-Pesa · Reliability  
**Stack** &nbsp;·&nbsp; TypeScript · Next.js · React · Tailwind · Java · Spring Boot · PostgreSQL · pgvector · Python · Supabase · Docker

## What I do

<picture>
  <source media="(max-width: 600px)" srcset="assets/cards-mobile.svg" />
  <img src="assets/cards.svg" width="100%" alt="What I build: full-stack products end to end. Reliability first: retries, offline, idempotency. Ship real things: real users and real payments, in production. Applied AI: search, matching, and evaluation you can trust." />
</picture>
